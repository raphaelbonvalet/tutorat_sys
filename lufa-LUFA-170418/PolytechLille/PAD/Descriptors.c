...
const USB_Descriptor_Configuration_t PROGMEM RelayBoard_ConfigurationDescriptor =
{
	...
	.PADInterfaceIN =
		{
			...
			.InterfaceNumber        = INTERFACE_ID_PAD_IN,
			.AlternateSetting       = 0,
    ...
    .PADInterfaceOUT =
		{
			...
			.InterfaceNumber        = INTERFACE_ID_PAD_OUT,
			.AlternateSetting       = 0,
    ...
    .PADReportINEndpointJoystick =
		{
			.Header                 = {.Size = sizeof(USB_Descriptor_Endpoint_t), .Type = DTYPE_Endpoint},

			.EndpointAddress        = PAD_IN_EPADDR_JOYSTICK,
			.Attributes             = (EP_TYPE_INTERRUPT | ENDPOINT_ATTR_NO_SYNC | ENDPOINT_USAGE_DATA),
			.EndpointSize           = PAD_EPSIZE,
			.PollingIntervalMS      = 0x05
		},
        
    .PADReportINEndpointButton =
		{
			.Header                 = {.Size = sizeof(USB_Descriptor_Endpoint_t), .Type = DTYPE_Endpoint},

			.EndpointAddress        = PAD_IN_EPADDR_BUTTON,
			.Attributes             = (EP_TYPE_INTERRUPT | ENDPOINT_ATTR_NO_SYNC | ENDPOINT_USAGE_DATA),
			.EndpointSize           = PAD_EPSIZE,
			.PollingIntervalMS      = 0x05
		},
        
    .PADReportOUTEndpoint =
		{
			.Header                 = {.Size = sizeof(USB_Descriptor_Endpoint_t), .Type = DTYPE_Endpoint},
 ...
 *  Descriptor.
 */
const USB_Descriptor_String_t PROGMEM RelayBoard_ProductString = USB_STRING_DESCRIPTOR(L"PAD");
